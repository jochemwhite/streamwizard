...
import ChannelRaidForm from "@/components/workflows/trigger-forms/channel_raid_form";
import ChannelRedemptionAdd from "@/components/workflows/trigger-forms/channel-redemption-add";
    ...
    triggers: [
      {
        ...
        event_id: null,
        icon: MdControlPoint,
        triggerForm: ChannelRedemptionAdd,
        placeholders: [
          "id",
          "broadcaster_user_id",
